...
export default function Contact() {
  ...
  return (
    <>
      <SectionShell id="contact" noPadding className="pt-44 pb-24 lg:pt-52 lg:pb-32">
        <SectionHeading
          eyebrow="Contact Us"
        ...
        <div className="theme-card mt-24 overflow-hidden p-8 lg:mt-28 sm:p-12">
          <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-end">
            <div>
              ...
              <h2 className={`${fraunces.className} mt-7 max-w-2xl text-[2.8rem] leading-[0.96] text-[#241913] dark:text-[#fff7ec] sm:text-[3.5rem]`}>
                Ready to build demand?
              </h2>
              <p className="theme-copy mt-5 max-w-xl text-[1.05rem] leading-7">
            ...
            <div>
              ...
              >
                <input
                  type="email"
                  className="h-14 flex-1 rounded-full border border-[#d6c7b4] bg-[#fffdf8] px-6 text-[1.05rem] text-[#241913] outline-none transition placeholder:text-[#a28b75] focus:border-brand-500 dark:border-[#4a392b] dark:bg-[#1d1713] dark:text-zinc-50 dark:placeholder:text-[#7d6a59]"
                ...
                <button
                  type="submit"
                  className="group relative flex h-14 cursor-pointer items-center justify-center rounded-full bg-brand-500 px-9 text-[1.05rem] font-medium text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.14),0_16px_34px_rgba(243,68,81,0.24)] transition hover:bg-brand-600"
                >
                  <span
                    aria-hidden="true"
      ...
      <SectionShell id="team-on-x" noPadding className="py-24 sm:py-28 lg:py-32">
        <SectionHeading
          eyebrow="Team on X"
        ...
        <div className="mt-20 grid auto-rows-[minmax(210px,auto)] gap-6 lg:mt-24 lg:grid-cols-6">
          <BentoCard
            href={`https://x.com/${TEAM_HANDLES[0].handle.slice(1)}`}
            target="_blank"
            rel="noreferrer"
            aria-label={`${TEAM_HANDLES[0].name} on X`}
            className="flex min-h-[430px] cursor-pointer flex-col p-8 lg:col-span-3 lg:row-span-2 sm:p-10"
          >
            ...
            <div className="mt-auto max-w-md">
              ...
              <h3 className={`${fraunces.className} mt-4 text-[3.2rem] leading-[0.94] text-[#241913] dark:text-[#fff7ec] sm:text-[4rem]`}>
                {TEAM_HANDLES[0].name}
              </h3>
              <p className="theme-copy mt-5 text-[15px] leading-7">
                Founder voice and direction for the communities RedSheel builds in.
              </p>
              <div className="mt-8 inline-flex max-w-full items-center gap-3 rounded-full border border-[#eadccd] bg-[#fff8ef]/70 px-5 py-3 text-[#5f4c3d] transition group-hover:border-brand-500/40 group-hover:text-brand-500 dark:border-[#3a2c21] dark:bg-[#19130f]/70 dark:text-[#d9ccb9] dark:group-hover:text-brand-300">
          ...
          {TEAM_HANDLES.slice(1).map((person) => (
            <BentoCard
              ...
              className="flex min-h-[210px] cursor-pointer flex-col p-7 lg:col-span-3 sm:p-8"
            >
              <div className="flex h-full flex-col justify-between gap-8 sm:flex-row sm:items-end">
                <div>
                  ...
                  <h3 className={`${fraunces.className} mt-8 text-[2.35rem] leading-[0.98] text-[#241913] dark:text-[#fff7ec]`}>
                    {person.name}
                  </h3>
                </div>
